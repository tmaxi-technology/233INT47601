...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 18, 2023 at 05:21 AM
...
(27, 48, '<p><iframe allowfullscreen src=\"https://short.ink/LCi6bsv4F\" frameborder=\"0\" height=\"360\" width=\"100%\" scrolling=\"0\"></iframe></p>', '1', '2023-11-21 09:26:47', '2023-11-21 09:26:47', 7),
(29, 50, '<p><iframe allowfullscreen src=\"https://short.ink/LCi6bsv4F\" frameborder=\"0\" height=\"360\" width=\"100%\" scrolling=\"0\"></iframe></p>', '1', '2023-11-21 19:52:43', '2023-11-21 19:52:43', 6);
...
(21, 'Tình Cảm', 'Tình Cảm', 1, 'tinh-cam'),
(22, 'Hoạt Hình', 'Hoạt Hình', 1, 'hoat-hinh'),
(23, 'Hành Động', 'Hành Động', 1, 'hanh-dong'),
(24, 'Viễn Tưởng', 'Viễn Tưởng', 1, 'vien-tuong'),
(25, 'Hài Hước', 'Hài Hước', 1, 'hai-huoc'),
(26, 'Kinh Dị', 'Kinh Dị', 1, 'kinh-di'),
(27, 'Võ Thuật', 'Võ Thuật', 1, 'vo-thuat'),
(28, 'Phim Ma', 'Phim Ma', 1, 'phim-ma'),
(29, 'Phiêu Lưu', 'Phiêu Lưu', 1, 'phieu-luu'),
(30, 'Gia Đình Học Đường', 'Gia Đình Học Đường', 1, 'gia-dinh-hoc-duong');
...
(29, 'SONIC PRIME', '93 phút', 'sonic-prime', 'Khi một trận chiến bùng nổ với tiến sĩ Eggman tàn phá vũ trụ, Sonic gấp rút băng qua nhiều chiều không gian song song để tìm lại bạn bè và cứu thế giới.', 'Poster-sonic-prime-sonic-prime-id_9110_2088007617QwD2Q5466.jpg', 6, 3, 1, 1, 1, 0, 'Sonic Prime (2022)', 0, '2023-02-23 13:55:57', '2023-02-23 13:55:57', NULL, 'sonic prime  sonic prime', NULL, 0, 'elTgqUW-NYE', 1, 'phimle', 73744),
...
(46, 'Phi Vụ Cuối Cùng', '93 phút', 'phi-vu-cuoi-cung', 'Sau khi bị phản bội và rời đi đã chết ở Ý, Charlie Crower và đội ngũ của anh ta lên kế hoạch cho một kẻ thù vàng phức tạp với đồng minh cũ của họ.', 'd90248737099dd36b502edf7e9f8cec09044.jpg', 12, 4, 4, 1, 1, 0, 'The Last Mission', 0, '2023-02-23 15:23:20', '2023-02-23 15:23:20', NULL, 'The Last Mission', NULL, 1, NULL, 1, 'phimle', 96470),
...
(48, 'phim hai', '93 phút', 'phim-hai', 'phim hai', 'Kien-Quai2114.jpg', 3, 4, 1, 1, 1, 0, 'Ze Tian Ji (Season 2)', 0, '2023-11-20 22:34:55', '2023-11-20 22:35:30', NULL, 'phim hai', NULL, 0, NULL, 1, 'phimle', 55136),
(49, 'Loki: Phần 2', '45 phút', 'loki-phan-2', 'Loki: Phần 2 – Loki Season 2 (2023) khi Steve Rogers, Tony Stark và Scott Lang quay trở về cột mốc 2012, ngay khi trận chiến ở New York kết thúc, để “mượn tạm” quyền trượng của Loki. Nhưng một tai nạn bất ngờ xảy đến, khiến Loki nhặt được khối lặp phương Tesseract và tiện thể tẩu thoát.', 'Loki6436.jpg', 3, 1, 1, 1, 1, 0, 'Loki Season 2 2023', 0, '2023-11-20 22:42:25', '2023-11-20 22:42:25', NULL, 'Loki: Phần 2 – Loki Season 2 (2023) khi Steve Rogers, Tony Stark và Scott Lang quay trở về cột mốc 2012, ngay khi trận chiến ở New York kết thúc, để “mượn tạm” quyền trượng của Loki. Nhưng một tai nạn bất ngờ xảy đến, khiến Loki nhặt được khối lặp phương Tesseract và tiện thể tẩu thoát.', NULL, 0, NULL, 6, 'phimle', 21898),
(50, 'Tết Ở Làng Địa Ngục', '50 Phút', 'tet-o-lang-dia-nguc', 'Tet O Lang Dia Nguc 2023', 'Phim-tet-o-lang-dia-nguc5538.jpg', 3, 1, 1, 1, 1, 0, 'Tet O Lang Dia Nguc 2023', 0, '2023-11-21 09:04:48', '2023-11-21 09:04:48', NULL, 'Tet O Lang Dia Nguc 2023', NULL, 0, NULL, 12, 'phimle', 5164);
...
--
ALTER TABLE `movies`
  ADD CONSTRAINT `movies_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `movies_ibfk_2` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `rating`
  ADD CONSTRAINT `rating_ibfk_1` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`id`);
COMMIT;
