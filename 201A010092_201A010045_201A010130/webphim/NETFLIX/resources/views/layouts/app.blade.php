...
<head>
  ...
  <link rel="shortcut icon" href="{{ asset('uploads/logo/' . $info->logo) }}"
  type="image/x-icon" />
  ...
  <!-- side nav css file -->
  <link href="{{ asset('backend/css/SidebarNav.min.css') }}" media="all"
  ...
  <script src="{{ asset('backend/js/pie-chart.js') }}" type="text/javascript">
  </script>
  <script type="text/javascript">
...
<body class="cbp-spmenu-push">
  @if (Auth::check())
          ...
          <nav class="navbar navbar-inverse">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="{{ url('/') }}">
                <h2
                  style="background-image: linear-gradient(to right top, #ea0707, #eb0500);color: transparent;
            ...
            <div class="collapse navbar-collapse"
              ...
              <ul class="sidebar-menu">
                ...
                <li
                  class="treeview {{ $segment == 'category' ? 'active' : '' }}">
                  {{-- <a href="#">
                ...
                <li
                  class="treeview {{ $segment == 'country' ? 'active' : '' }}">
                  <a href="#">
                ...
                <li
                  class="treeview {{ $segment == 'linkmovie' ? 'active' : '' }}">
                  <a href="#">
    ...
    <div class="sticky-header header-section">
      <div class="header-left" style="height: 62px">
        <!--toggle button start-->
                ...
                <div class="profile_img">
                  ...
                  <div class="user-name"
                    style="color: transparent;
                        ...
                        background-clip: text;
                        -webkit-text-fill-color: transparent;
                        -webkit-background-clip: text;;margin-top: 18px;">
                    {{ Auth::user()->name }}
                  </div>
    ...
    <div id="page-wrapper">
      <div class="main-page">
        <div class="col_3">
          ...
          <div class="col-md-3 widget widget1">
            <div class="r3_counter_box">
              <i class="pull-left fa fa-mars-double user1 icon-rounded"></i>
              <a href="{{ route('genre.index') }}">
                <div class="stats">
                  <h5>
    ...
    <div class="footer">
      <p>
        ...
        <a href="http://127.0.0.1:8000/" target="_blank">Netflix</a>
      </p>
    </div>
    </div>
  @else
  ...
  <!-- side nav js -->
  <script src="{{ asset('backend/js/SidebarNav.min.js') }}"
  ...
  <script type="text/javascript">
    $(document).on('change', '.file_image', function() {
      ...
      form_data.append("file", document.getElementById("file-" + movie_id)
        .files[0]);
  ...
  <style>
    ...
    body::-webkit-scrollbar-thumb {
      --general-gradient-secondary: #fcb564, #ff65f2, #6a5af9;
