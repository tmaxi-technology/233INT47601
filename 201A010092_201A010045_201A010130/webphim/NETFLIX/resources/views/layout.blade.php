    ...
    <div class="container">
      <div class="row" id="headwrap">
        <div class="col-md-3 col-sm-6 slogan">
          <p>
            <a class="logo" title="phim hay" href="{{ route('homepage') }}">
              Netflix
              ...
              <div class="form-group form-timkiem">
                <div class="input-group col-xs-12">
                  <form action="{{ route('tim-kiem') }}" method="GET">
                    <input id="timkiem" type="text" data-original-title="Nhấn Enter để tìm kiếm" data-toggle="tooltip" data-placement="bottom" name="search" class="form-control" placeholder="Tìm kiếm..." autocomplete="off">
                    <i class="animate-spin hl-spin4 hidden"></i>
                  </form>
                </div>
              </div>
              <ul class="list-group" id="result" style="display: none;max-height: 59vh;
                        overflow-y: auto;border: 1px solid #273e52;">
              </ul>
            </div>
          </div>
        </div>
        <div class="col-md-4 hidden-xs">
          <div>
            ...
            <div class="header-right">
              <div class="profile_details" style="padding-top: 10px">
                <ul>
                  <li class="dropdown profile_details_drop">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                      <div class="profile_img">
                        ...
                        <div class="user-name" style="color: transparent;
                        background-image: linear-gradient(to right top,#6cabfc, #6cffae);
                        background-clip: text;
                       -webkit-text-fill-color: transparent;
                        -webkit-background-clip: text;;margin-top: 0;">
                          {{ Auth::user()->name }}
                    ...
                    <ul class="dropdown-menu drp-mnu" style="margin-top: -7px;">
              ...
              @endif
              <div id="get-bookmark" class="box-shadow toggled">
                <i class="fa fa-bookmark" aria-hidden="true" style="color: yellow"></i>
                <span style="color: #fff;">Phim yêu thích</span>
                <span class="count" style="background-image: linear-gradient(to right top,#25ea0d, #0ef3b8);">0</span>
              </div>
            </div>
            ...
            <div id="bookmark-list" class="hidden bookmark-list-on-pc">
              <div class="halim-bookmark-box">
                <div class="section-bar clearfix">
                  ...
                  <span class="remove-all-bookmark box-shadow">x Remove
                    all</span>
                </div>
                <ul class="halim-bookmark-lists" id="list-fav">
                  <li class="bookmark-list" style="text-align: center;
                     color: #ccc;">
                    Nothing found!</li>
                </ul>
    ...
    <div class="container">
      <nav class="navbar halim-navbar main-navigation" role="navigation" data-dropdown-hover="1">
        <div class="navbar-header">
          ...
          <button type="button" class="navbar-toggle collapsed pull-right get-bookmark-on-mobile" style="color:#fff;display: none;">
            Phim yêu thích
          ...
          <div class="menu-menu_1-container">
            <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
              <li class="current-menu-item">
                <a title="Trang Chủ" href="{{ route('homepage') }}">Trang
                  Chủ</a>
              </li>
              ...
              <li class="mega dropdown">
                ...
                <ul role="menu" class=" dropdown-menu">
                  ...
                  <li>
                    <a title="{{ $count->title }}" href="{{ route('country', $count->slug) }}">{{ $count->title }}
                    </a>
                  </li>
                  @endforeach
                </ul>
              ...
              {{-- <li class="mega dropdown">
                <a title="Năm phim" href="#" data-toggle="dropdown"
                  class="dropdown-toggle" aria-haspopup="true">Năm phim
                  <span class="caret"></span>
                </a>
                <ul role="menu" class=" dropdown-menu">
          ...
          $.getJSON('/json_file/movies.json', function(data) {
            $.each(data, function(key, value) {
              if (value.title.search(expression) != -1) {
                $('#result').append(
                  '<li style="cursor:pointer; display: flex; max-height: 200px;" class="list-group-item"><img src="uploads/movie/' +
                  value.image +
                  '" width="35px" height="44px"/><div style="flex-direction: column; margin-left: 8px; margin-top: 6px;"><span>' +
                  value.title +
                  '</span><span style="display: -webkit-box; max-height: 8.2rem; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis; white-space: normal; -webkit-line-clamp: 4; line-height: 1.6rem;"  class="text-muted"> | ' +
                  value.name_eng + '</span></div></li>');
              }
            });
          })
        } else {
    ...
    $(document).ready(function() {
      ...
      $('.filter-sidebar').click(function() {
        ...
        $.ajax({
          ...
          success: function(data) {
            $('#halim-ajax-popular-post-default').css("display",
              "none");
            $('#show_data').html(data);
          }
        });
