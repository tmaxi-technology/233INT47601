...
<div class="container-fluid">
  <div class="row justify-content-center">
    <div class="col-md-12">
      <a href="{{ route('movie.create') }}" class="btn btn-primary">Thêm
        Phim</a>
        ...
        <table class="table" id="tablephim">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                @php
                $options = ['0' => 'HD', '1' => 'SD', '2' => 'HDCam', '3' => 'Cam', '4' => 'FullHD', '5' => 'Trailer'];
                @endphp
                <select id="{{ $cate->id }}" class="resolution_choose">
                  @foreach ($options as $key => $resolution)
                  <option {{ $cate->resolution == $key ? 'selected' : '' }} value="{{ $key }}">{{ $resolution }}
                  </option>
                  @endforeach
                </select>
              </td>
              ...
              <td>
                ...
                'category_id',
                $category,
                isset($cate) ? $cate->category->id : '',
                ['class' => 'category_choose', 'id' => $cate->id],
                ) !!}
              </td>
              <td>
              ...
              <td>
                ...
                'country_id',
                $country,
                isset($cate) ? $cate->country->id : '',
                ['class' => 'country_choose', 'id' => $cate->id],
                ) !!}
              </td>
              ...
              <td>
                <form action="POST">
                  ...
                  0,
                  20,
                  isset($cate->season) ? $cate->season : '0',
