          ...
          <div class="halim-movie-wrapper">
            <div class="title-block">
              <div id="bookmark" data-toggle="tooltip" data-placement="right"
                ...
                class="halim_bookmark bookmarked bookmark-img-animation primary_ribbon"
                data-thumbnail="{{ asset('uploads/movie/' . $movie->image) }}"
                data-id="38424">
            ...
            <div class="movie_info col-xs-12">
                ...
                @else
                  <a href="#watch_trailer"
                    style="display:block;
                           ...
                           box-shadow: 0 4px 15px 0 rgb(83 176 57 / 75%)!important;"
              ...
              <div class="film-poster col-md-9">
                ...
                <ul class="list-info-group">
                  ...
                  <li class="list-info-group-item">
                    ...
                    <a href="{{ route('category', $movie->category->slug) }}"
                      rel="category tag">{{ $movie->category->title }}
                    </a>
                  </li>
                  <li class="list-info-group-item">
                    <span>Quốc gia</span> :
                    <a href="{{ route('country', $movie->country->slug) }}"
                      rel="tag">{{ $movie->country->title }}
                    </a>
                  </li>
                  <li class="list-info-group-item">
                ...
                <div class="movie-trailer">
                  ...
                  <div class="fb-save" data-uri="{{ $current_url }}"
                    data-size="small"></div>
                </div>
              </div>
            </div>
