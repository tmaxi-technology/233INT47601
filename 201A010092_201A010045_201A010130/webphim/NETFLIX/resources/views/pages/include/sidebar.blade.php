<style type="text/css">
  li.nav-item.active a {
    border-radius: 5px;
    padding: 6px;
    background-image: linear-gradient(to right top, rgb(252, 108, 143, 0.8), rgb(255, 184, 108, 0.8));
        ...
        <div id="halim-ajax-popular-post" class="popular-post">
          @foreach ($phimhot_sidebar as $key => $hot_sidebar)
            <div class="item post-37176">
              <a href="{{ route('movie', $hot_sidebar->slug) }}"
