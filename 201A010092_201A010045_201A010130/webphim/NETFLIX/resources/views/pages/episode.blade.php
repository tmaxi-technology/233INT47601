          ...
          <div class="movie_info col-xs-12">
            ...
            <div class="movie-poster col-md-3">
              ...
              <a href="#watch_trailer" style="display:block;
                           ...
                           background-image: linear-gradient(to right,#009245,#d0c200,#00A8C5,#D9E021)!important;
                           box-shadow: 0 4px 15px 0 rgb(83 176 57 / 75%)!important;" class="btn btn-primary watch_trailer">Xem Trailer</a>
              @endif
            </div>
            <div class="film-poster col-md-9">
              <h1 class="movie-title title-1">{{ $movie->title }}
              </h1>
              ...
              <ul class="list-info-group">
                ...
                <ul class="list-inline rating" title="Average Rating">
                  @for ($count = 1; $count <= 5; $count++) @php if ($count <=$rating) { $color='color:#ffcc00;' ; } else { $color='color:#ccc;' ; } @endphp <li title="star_rating" id="{{ $movie->id }}-{{ $count }}" data-index="{{ $count }}" data-movie_id="{{ $movie->id }}" data-rating="{{ $rating }}" class="rating" style="cursor:pointer; {{ $color }}
                        font-size:30px;">
                    &#9733;
                    </li>
                    @endfor
    ...
    <section class="related-movies">
      {{-- <div id="halim_related_movies-2xx" class="wrap-slider">
         ...
         <div id="halim_related_movies-2" class="owl-carousel owl-theme related-film">
            ...
            <article class="col-md-2 col-sm-3 col-xs-6 thumb grid-item post-38498">
