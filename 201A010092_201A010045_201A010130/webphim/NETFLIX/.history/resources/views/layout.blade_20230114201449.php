            ...
            $.getJSON('/json_file/movies.json', function(data) {
               $.each(data, function(key, value) {
                  if(value.title.search(expression) != -1)  {
                     $('#result').append('<li style="cursor:pointer;class="list-group-item"><img width="40" height="40" src="uploads/movie/'+value.image+'"/>'+value.title+'<br/>| '+value.description+'</span></div></li>');
                  }
               })
            })
         } 
