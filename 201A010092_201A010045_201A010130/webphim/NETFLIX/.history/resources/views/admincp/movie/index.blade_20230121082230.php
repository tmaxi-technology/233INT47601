            ...
            <table class="table table-responsive" id="tablephim">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row">{{$key}}</th>
                  <td>{{$cate->title}}</td>
                  <td><a href="{{route('add-episode')}}" class="btn btn-primary btn-sm">Thêm tập phim</a></td>
                  <td>
                    @if($cate->tags!=NULL)
                  ...
                  <td>
                    {!! Form::selectYear('year', 1980, 2023, isset($cate->year) ? $cate->year : '',['class' => 'select-year','id'=>$cate->id])!!}
                  </td>
                  <td>
