...
<head>
  ...
  <link rel='stylesheet' id='wp-block-library-css' href='{{asset("css/style.css?ver=5.7.2")}}' media='all' />
          ...
          <div class="section-heading">
            ...
            <ul class="heading-nav pull-right hidden-xs">
              <li class="section-btn halim_ajax_get_post" data-catid="4" data-showpost="12"
                data-widgetid="halim-advanced-widget-4" data-layout="6col"><span data-text="Chiếu Rạp"></span></li>
            </ul>
          </div>
              ...
              <div class="halim-item">
                <a class="halim-thumb" href="chitiet.php">
                  <figure><img class="lazy img-responsive"
                      ...
                      alt="BẠN CÙNG PHÒNG CỦA TÔI LÀ GUMIHO" title="BẠN CÙNG PHÒNG CỦA TÔI LÀ GUMIHO"></figure>
