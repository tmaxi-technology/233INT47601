...
<div class="section-bar clearfix">
      <div class="section-title">
          <span style="    background: #1b2a39;
          border: 1px solid #1b2a3900;
          background-size: 200% 100%;
          background-image: linear-gradient(to right,#f5ce62,#e43603,#fa7199,#e85a19);
          background-image: linear-gradient(to right,#ff00cc 0%,#333399 51%,#ff00cc 100%);">Phim Hot</span>
      </div>
    </div>
...
<div id="halim_tab_popular_videos-widget-7" class="widget halim_tab_popular_videos-widget">
    ...
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
      <li class="nav-item active">
        <a class="nav-link filter-sidebar" id="pills-home-tab" data-toggle="pill" href="#ngay" role="tab" aria-controls="pills-home" aria-selected="true" style="background: #1b2a39;
        border: 1px solid #1b2a3900;s
        background-size: 200% 100%;
        background-image: linear-gradient(to right,#f5ce62,#e43603,#fa7199,#e85a19);
        background-image: linear-gradient(to right,#ff00cc 0%,#333399 51%,#ff00cc 100%);">Ngày</a>
      </li>
      <li class="nav-item">
        <a class="nav-link filter-sidebar" id="pills-profile-tab" data-toggle="pill" href="#tuan" role="tab" aria-controls="pills-profile" aria-selected="false" style="    background: #1b2a39;
        border: 1px solid #1b2a3900;
        background-size: 200% 100%;
        background-image: linear-gradient(to right,#f5ce62,#e43603,#fa7199,#e85a19);
        background-image: linear-gradient(to right,#ff00cc 0%,#333399 51%,#ff00cc 100%);">Tuần</a>
      </li>
      <li class="nav-item">
        <a class="nav-link filter-sidebar" id="pills-contact-tab" data-toggle="pill" href="#thang" role="tab" aria-controls="pills-contact" aria-selected="false" style="    background: #1b2a39;
        border: 1px solid #1b2a3900;
        background-size: 200% 100%;
        background-image: linear-gradient(to right,#f5ce62,#e43603,#fa7199,#e85a19);
        background-image: linear-gradient(to right,#ff00cc 0%,#333399 51%,#ff00cc 100%);">Tháng</a>
      </li>
    </ul>
