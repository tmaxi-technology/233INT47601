    ...
    <div class="main-content">
        ...
        <aside class="sidebar-left">
            ...
            >
                ...
                {{-- <li class="treeview {{($segment=='visitors') ? 'active' : ''}}">
                    <a href="#">
                        <i class="fa fa-video-camera"></i>
                        <span>User truy cập</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li>
                        ...
                        <a href="{{route('visitor.index')}}"
                            ><i class="fa fa-angle-right"></i>Đang online</a>
                        </li>
                    </ul>
                </li> --}}
                </ul>
        ...
        <div class="main-page">
            ...
            {{-- <div class="col-md-3 widget">
                <div class="r3_counter_box">
                    <div class="stats">
                        <span style="color:green">Đang online : {{\Tracker::onlineUsers()->count()}}</span><br>
                        <span>Tổng User truy cập : {{$total_users}}</span><br>
                        <span>Tổng User truy cập tuần : {{$total_users_week}}</span><br>
                        <span>1 Tháng : {{$total_users_month}}</span><br>
                        <span>3 Tháng : {{$total_users_3month}}</span><br>
...
<script type="text/javascript">
    $('.show_video').click(function(){
        ...
        $.ajax({
            ...
            đata:{movie_id: movie_id, episode_id: episode_id},
