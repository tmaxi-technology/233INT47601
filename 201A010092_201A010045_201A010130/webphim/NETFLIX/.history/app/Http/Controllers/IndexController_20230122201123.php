...
class IndexController extends Controller
{
    public function locphim()
    {
        ...
        if ($sapxep == '' && $genre == '' && $country == '' &&  $year == '') {
            ...
            $movie = Movie::withCount('episode')->where('country_id', '=', $country)->where('genre_id', '=', $country)->where('year', '=', $year)->orderBy('ngaycapnhat', 'DESC')->paginate(40);
            return view('pages.filter', compact('category', 'genre', 'country', 'cate_slug', 'movie', 'phimhot_sidebar', 'phimhot_trailer'));
        }
    }
