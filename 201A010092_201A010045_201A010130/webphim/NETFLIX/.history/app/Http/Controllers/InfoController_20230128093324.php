    ...
    public function update(Request $request, $id)
    {
        $data = $request->validate(
            [
                ...
                'hinhanh' => 'require|image|mimes:jpg,png,jpeg,gif,svg|max:2048|dimensions:min_width=100,min_height=100,max_width=2000,max_height=2000',
            ],
            [
        ...
        $info->save();
        toastr()->success('Cập nhật', 'Cập nhật thông tin web thành công!');
