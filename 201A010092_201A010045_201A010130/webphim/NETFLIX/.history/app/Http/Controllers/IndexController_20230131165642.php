...
class IndexController extends Controller
{
    ...
    public function watch($slug, $tap)
    {
        ...
        $server_movie = LinkMovie::where('movie_id', $movie->id)->orderBy('episode', 'DESC')->get();
        return view('pages.watch', compact('movie', 'episode', 'tapphim', 'related', 'meta_title', 'meta_description', 'meta_image', 'server', 'server_movie'));
    }
