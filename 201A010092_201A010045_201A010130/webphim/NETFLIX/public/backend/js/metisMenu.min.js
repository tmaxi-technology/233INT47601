  ...
  (d.prototype = {
    init: function () {
      var b = this.element,
        ...
        f = this;
      this.isIE() <= 9
        ? (b.find('li.active').has('ul').children('ul').collapse('show'),
          b.find('li').not('.active').has('ul').children('ul').collapse('hide'))
        ...
        b
          ...
          .on('click.' + e, function (b) {
            return (
              b.preventDefault(),
              f.settings.doubleTapToGo &&
              f.doubleTapToGo(a(this)) &&
              '#' !== a(this).attr('href') &&
              '' !== a(this).attr('href')
                ? (b.stopPropagation(), void (c.location = a(this).attr('href')))
                : (a(this).parent('li').toggleClass('active').children('ul').collapse('toggle'),
    ...
    isIE: function () {
      for (
        var a, b = 3, d = c.createElement('div'), e = d.getElementsByTagName('i');
        (d.innerHTML = '<!--[if gt IE ' + ++b + ']><i></i><![endif]-->'), e[0];
    ...
    doubleTapToGo: function (a) {
      ...
      return a.hasClass('doubleTapToGo')
        ...
        ? (b.find('.doubleTapToGo').removeClass('doubleTapToGo'), a.addClass('doubleTapToGo'), !1)
        : void 0;
    },
    remove: function () {
